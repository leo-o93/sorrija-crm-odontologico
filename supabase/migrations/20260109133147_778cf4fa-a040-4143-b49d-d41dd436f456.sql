...
-- Função para criar regras de transição padrão
...
-- Policies para recurring_payments
...
-- Policy especial para organizations - super admin pode ver todas
...
-- Policy para organization_members - super admin pode gerenciar todos
CREATE POLICY "Super admins can manage all memberships" ON organization_members
  FOR ALL USING (is_super_admin());

-- =============================================
-- FASE 5: Colunas extras em organizations
-- =============================================
...
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS address JSONB DEFAULT '{}';
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS business_hours JSONB DEFAULT '{}';
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS timezone TEXT DEFAULT 'America/Sao_Paulo';
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS welcome_message TEXT;
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS message_signature TEXT;

-- Colunas extras em financial_transactions
ALTER TABLE financial_transactions ADD COLUMN IF NOT EXISTS supplier_id UUID REFERENCES suppliers(id);
ALTER TABLE financial_transactions ADD COLUMN IF NOT EXISTS recurring_payment_id UUID REFERENCES recurring_payments(id);
...
-- =============================================
-- FASE 8: Habilitar Realtime para webhooks
-- =============================================
